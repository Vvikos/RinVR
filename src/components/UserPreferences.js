...
function ChangeGrid({position})
{
    ...
    return (
        <>
            ...
            <DropDown position={[0, -0.62, 1]} backgroundColor={blue_button} scale={[0.9, 0.25, 0.1]} color={blue_button} onChangeValue={setDisplayAngles} dropDownValue={displayAngles}  fontSize={0.04}/>
